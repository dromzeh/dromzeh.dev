---
title: skowt.cc - infrastructure rewrite
description: Rewriting a 300K+ MAU site away from legacy infrastructure.
date: 19-08-2025
slug: skowt-rewrite-blog
---

back in june 2022, i started working on what would become [skowt.cc](https://skowt.cc) (formerly wanderer.moe). i was still very new to webdev at the time. i had a personal website written in plain html, css and js, and hosted a temporary file uploader i wrote with flask. so the overall experience has been truly a learning curve - and by learning curve, i mean repeatedly face-planting into walls until i figured out how to build doors.

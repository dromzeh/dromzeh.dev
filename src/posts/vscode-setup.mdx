...
This post has been updated to reflect my current VSCode config as of 1st June 2025. The below screenshot is my old config with [Apc Customize UI++](https://marketplace.visualstudio.com/items?itemName=drcika.apc-extension) and [GlassIt-VSC](https://marketplace.visualstudio.com/items?itemName=s-nlf-fh.glassit).
...
- [Import Cost](https://marketplace.visualstudio.com/items?itemName=wix.vscode-import-cost) - Displays package sizes: I notice some performance issues with this and therefore rarely use this now.

...
There's joy in learning new concepts, joy when something finally clicks and makes sense to you, joy when you help someone with code you'd wrote.
...
Most people can immediately tell when software has been vibe coded. There's no soul, no human fingerprint, no evidence that someone actually cares about the problem they're claiming to solve.

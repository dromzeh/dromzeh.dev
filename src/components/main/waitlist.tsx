    ...
    return (
        <>
            <Link href="https://waitlist.wanderer.moe/" target="_blank">
                <button className="mb-8 relative inline-flex h-7 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-neutral-400 focus:ring-offset-2 focus:ring-offset-neutral-50 group">
